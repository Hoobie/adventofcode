...
object Day18DuetPart1 {
    ...
    private tailrec fun run(registers: Map<String, Long>, instructions: List<Instruction>, idx: Long): Long {
        if (registers["jmp"] != 0L) {
...
fun main(args: Array<String>) {
    ...
    println("Received frequency: " + Day18DuetPart1.getRecoveredFrequency(input))
}
