...
a new programming language (I've got familiar with [Kotlin](https://kotlinlang.org)) and to compare your solutions with friends.
...
10 minutes 9 seconds in opposite to the next day's 6 minutes 2 seconds. The hardest task overall seemed to be the 23rd day's second part
...
## Summary
I hope you had fun reading this post and maybe even solving whole Advent of Code. Remember, 
even if you didn’t finish some of the puzzles, you still can. There is no time limit. 
The puzzles from the previous editions are also available.
